...
```{r example12, warning = FALSE, eval=FALSE}
...
```{r example13, warning = FALSE, eval=FALSE}
...
```{r example14, warning = FALSE, eval=FALSE}
...
```{r example15, warning = FALSE, eval=FALSE}
...
```{r example18, warning = FALSE, eval=FALSE}
...
```{r example19, warning = FALSE, eval=FALSE}
random_df_l <- as.data.frame(t(random_df_w))
