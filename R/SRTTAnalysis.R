...
#' @examples
#' # Basic usage
#' data_wide <- cbind(999, (as.data.frame(t(stats::rnorm(500, mean = 1, sd = 0.1)))))
#' SRTT_analysis(data_wide, format= "Wide")
#' 
#' data_long <- rbind(999 , (as.data.frame(stats::rnorm(500, mean = 1, sd = 0.1))))
...
#'for (i in 1:10) { num_nas <- sample(50:300, 1)
...
#' @examples
#' # Basic usage
#' data_wide <- cbind(999, (as.data.frame(t(stats::rnorm(1200, mean = 1, sd = 0.1)))))
...
#' 
#' data_long <- rbind(999 , (as.data.frame(stats::rnorm(1200, mean = 1, sd = 0.1))))
